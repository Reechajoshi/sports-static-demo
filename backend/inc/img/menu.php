...
<?php
		...
		");
			...
			echo("tabs.addIFrameTab(menuid + 'admall', { name: 'ALL', iframeURL: '$me?b=showimg', txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid' } );");
